...
for a in my_input:
    for mov in a:
        if mov == "R":
            ...
            curpos = (curpos[0] + 1, curpos[1])
        if curpos[0] < 0 or curpos[0] > 2 or curpos[1] < 0 or curpos[1] > 2:
            curpos = onelastnice
        else:
            onelastnice = curpos

    path.append(keyb[curpos[0]][curpos[1]])
print("Part1: {}".format("".join(str(a) for a in path)))
...
for a in my_input:
    for mov in a:
        if mov == "R":
            ...
            curpos = (curpos[0] + 1, curpos[1])
        if curpos[0] < 0 or curpos[0] > 4 or curpos[1] < 0 or curpos[1] > 4 or superkeyb[curpos[0]][curpos[1]] == 0:
            curpos = onelastnice
        else:
            onelastnice = curpos
    path2.append(superkeyb[curpos[0]][curpos[1]])
