...
public class Day25 {
    public static void main(String[] args) {
        ...
        BigInteger firstCode = BigInteger.valueOf(20151125);
        BigInteger base = BigInteger.valueOf(252533);
        BigInteger mod = BigInteger.valueOf(33554393);

        int exp = (row + col - 2) * (row + col - 1) / 2 + col;
        System.out.println(exp);

        // part 1:
        System.out.println(
                (base
                        .modPow(BigInteger.valueOf(exp-1), mod)
                        .multiply(firstCode))
                        .remainder(mod)
        );
    }
